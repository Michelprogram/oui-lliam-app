...
<template>
  <Card class="h-full min-h-0 flex flex-col">
    <CardHeader>
      <CardTitle class="flex items-center gap-2">Clip History </CardTitle>
      <CardDescription>Recent clip operations</CardDescription>
    </CardHeader>
    <CardContent class="flex-1 min-h-0">
      <ScrollArea class="h-full min-h-0">
        <div class="space-y-3 pr-4">
          ...
          >
            <div class="space-y-2">
              <h4 class="font-semibold text-sm">{{ clip.title }}</h4>
              <div
